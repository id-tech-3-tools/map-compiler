...
:: Compile stages
set BSPStage=-bsp -game %GameName% -fs_basepath "%GameDirectory%" -v -meta -samplesize 4
set VisStage=-vis -game %GameName% -fs_basepath "%GameDirectory%" -v -saveprt
set LightStage=-light -game %GameName% -fs_basepath "%GameDirectory%" -v -fast -fastallocate -samples 3 -samplesize 4 -bounce 8 -shade -patchshadows -lightmapsize 2048
