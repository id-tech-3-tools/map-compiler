...
set CompilerArguments=-convert -game %GameName% -fs_basepath "%GameDirectory%" -v -format map %ExtraSwitches%
...
:printHelp
    echo Basic usage:
    echo    bsp-to-map.bat mapname [output relative path]
    echo    bsp-to-map.bat castle.bsp
    echo    bsp-to-map.bat castle.bsp models/castle
    goto atExit
